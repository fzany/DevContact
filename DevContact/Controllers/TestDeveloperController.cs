...
namespace DevContact.Controllers
{
    ...
    [ApiController]
    public class TestDeveloperController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpGet]
        [Route("test/developer/fetch/{guid}")]
        ...
        /// <returns></returns>
        [HttpGet]
        [Route("test/developer/fetch/stack/{stack}")]
        ...
        /// <returns></returns>
        [HttpGet]
        [Route("test/developer/fetch/email/{email}")]
        ...
        /// <returns></returns>
        [HttpDelete]
        [Route("test/developer/delete/{guid}")]
